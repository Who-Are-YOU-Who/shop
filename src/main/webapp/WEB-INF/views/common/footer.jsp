    ...
    <div class="row">
      ...
      <div class="col-md-4">
        ...
        <ul class="fa-ul">
          ...
          <li><i class="fa fa-li fa-angle-right"></i> <a href="#">QnA</a></li>
      ...
      <div class="col-md-4">
        ...
        <address>
          <strong>Whizlab, Inc.</strong><br />
          인천광역시 남동구 호구포로 194<br />
          마크원  IT동 1116호<br /><br />
          <abbr title="Phone">Phone:</abbr> (010) 2600-9152<br />
          <abbr title="Fax">Fax:</abbr> (123) 456-7891<br />
          <abbr title="Email">Email:</abbr> <a href="mailto:kh.lee@whizlab.co.kr">kh.lee@whizlab.co.kr</a><br />
        </address>
      </div>
      <!-- END col-3 -->
    </div>
...
<div id="footer-copyright" class="footer-copyright">
  ...
  <div class="container">
    <div class="copyright">
      Copyright &copy; 2018 SeanTheme. All rights reserved.
    </div>
  </div>
  <!-- END container -->
</div>
