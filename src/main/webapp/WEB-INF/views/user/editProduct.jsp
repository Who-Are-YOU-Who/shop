...
<div id="content" class="content">
    ...
    <form action="/updateProduct" method="post" enctype="multipart/form-data" class="form-horizontal form-bordered" id="editForm">
        <!-- begin row -->
            ...
            <div class="col-lg-5">
                ...
                <div class="panel panel-inverse" >
                    ...
                    <div class="panel-heading">
                        <h4 class="panel-title">상품기본정보 수정</h4>
                    </div>
                    <!-- end panel-heading -->
                    <!-- begin panel-body -->
                    <div class="panel-body panel-form">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="prodName" name="prodName" placeholder="상품명" value="<%=productVO.getProdName()%>" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">상품코드</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="prodCode" name="prodCode" placeholder="상품코드" value="<%=productVO.getProdCode()%>"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">제조국</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="prodManufacturingCountry" name="prodManufacturingCountry" placeholder="제조국" value="<%=productVO.getProdManufacturingCountry()%>" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">제조사</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="prodManufacturingFactory" name="prodManufacturingFactory" placeholder="제조사" value="<%=productVO.getProdManufacturingCountry()%>"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">주요성분</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="prodComponent" name="prodComponent" placeholder="주요성분" value="<%=productVO.getProdComponent()%>" />
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">배송비</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="deliveryPrice" name="deliveryPrice" placeholder="배송비" value="<%=productVO.getDeliveryPrice()%>"/>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-4 col-form-label">상품간단설명</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" id="simpleExplain" name="simpleExplain" placeholder="상품간단설명" value="<%=productVO.getSimpleExplain()%>"/>
                            </div>
                        </div>
                    </div>
                    <!-- end panel-body -->
                ...
                <div class="panel panel-inverse">
                    <div class="panel-heading">
                        <h4 class="panel-title">썸네일 수정</h4>
                    </div>
                    <div class="panel-body text-inverse">
                        <div id="dropzone">
                            <div class="row">
                                ...
                                <%
                                    List<ProductImgVo> productImgVoList = productVO.getProdImgList();
                                    for(int j = 0; j<4; j++){%>
                               
                                <div class="col-md-2 m-10" style="border: 2px dashed grey; height: 200px; border-radius: 5px; display: flex; text-align: center; justify-content : center; align-items : center;" id="input-file-div<%=j+1%>>">
                                    <img src="image/product/<%=productImgVoList.get(j).getProdImgPath()%>" style='position:absolute; width:180px; height: 180px; z-index:1; jus;'>
                                    <label class="input-file-button" for="input-file<%=j+1%>" style="margin: auto; z-index: 2;">
                                        썸네일1 추가
                                        <span class="dz-note needsclick">
										(사진규격은 000*000을 권장합니다.)
									</span>
                                    </label>
                                    <button type="file" id="input-file<%=j+1%>" name="files" style="display:none;" onchange="fileAdd(<%=j+1%>)" ></button>
                                </div>
                ...
                <div class="col-md-10 ui-sortable" >
                    ...
                    <div class="panel panel-inverse m-b-0">
                        ...
                        <div class="panel-body p-0" id="prodSummernote" >
                            <textarea id="summernote" name="summernote" class="summernote"><%=productVO.getProdSummernote()%></textarea>
                        </div>
                    </div>
                    <!-- end panel -->
                </div>
        ...
        <%--end row--%>
        <button type="submit" class="btn btn-primary btn-lg" onclick="formSubmit()">수정하기</button>
    </form>
</div>
